...
* **Gestão e Segurança:** Fluxo assíncrono de recuperação de senhas via e-mail (`ctx.waitUntil`) e controle total de categorias e contas com proteção de histórico (*soft-delete*).
